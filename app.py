...
def db_connection():
	mongo_client = pymongo.MongoClient("mongodb+srv://mongo_base_user_1:<paz>@cluster0.0zbkf.mongodb.net/myFirstDatabase?retryWrites=true&w=majority&ssl=true&ssl_cert_reqs=CERT_NONE")
